...
const DEFAULT_AGENT = {
  ...
  description: "AI Voice Assistant for Restaurant Inventory",
}
  ...
  return (
    <div className="flex h-screen bg-background">
      ...
      <div className="flex-1 flex flex-col overflow-hidden">
        <PageHeader title="AI Agent" subtitle="Voice Assistant" />
        <div className="flex-1 overflow-auto p-6">
          <Card
            className={cn(
              "mx-auto flex h-full max-h-[600px] w-full max-w-3xl flex-col gap-0 overflow-hidden"
            )}
          >
            <CardHeader className="flex shrink-0 flex-row items-center justify-between pb-4">
              <div className="flex items-center gap-4">
                <div className="ring-border relative size-12 overflow-hidden rounded-full ring-1">
                  <Orb
                  ...
                  <div className="flex items-center gap-2">
                    {errorMessage ? (
                      ...
                      <p className="text-muted-foreground text-xs">
                        Tap to start voice chat or type a message
                      </p>
                    ...
                    <ConversationEmptyState
                      ...
                      description={
                        agentState === "connecting"
                          ...
                          : agentState === "connected"
                            ? "Ready to chat"
                            : "Ask about inventory, orders, or suppliers"
                      }
                    />
                  ) : (
                        ...
                        <div key={index} className="flex w-full flex-col gap-1">
                          <Message from={message.role}>
                            ...
                            {message.role === "assistant" && (
                              <div className="ring-border size-8 flex-shrink-0 self-end overflow-hidden rounded-full ring-1">
                                <Orb
                                  className="h-full w-full"
                                  agentState={
              ...
              <div className="flex w-full items-center gap-2">
                <div className="flex flex-1 items-center gap-2">
                  <Input
                    ...
                    placeholder="Ask about inventory, orders, or suppliers..."
